...
class UploadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create upload" do
    assert_difference('Upload.count') do
      post uploads_url, params: { upload: { booking_id: @upload.booking_id, original_file_name: @upload.original_file_name } }
    end
  ...
  test "should update upload" do
    patch upload_url(@upload), params: { upload: { booking_id: @upload.booking_id, original_file_name: @upload.original_file_name } }
